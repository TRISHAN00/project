...
import {fetchDevelopingSkills} from "../../api/redux/DevelopingSkill";
...
const DevelopingSkills = () => {
    ...
    // api call
    useEffect(() => {
        let api_url = apiEndPoints.DEVELOPING_SKILL
        dispath(fetchDevelopingSkills([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state.developingSkill)
    ...
    return (
        <HelmetProvider>
            <Helmet>
                ...
                <meta name="Developing Skills"
                      content="Studying abroad is an excellent opportunity for Bangladeshi students to gain international exposure, broaden their horizons,"/>
            </Helmet>
