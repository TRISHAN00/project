...
import {fetchStudyInCanadaDetails} from "../../api/redux/StudyInCanada";

const StudyInCanadaDetails = () => {

    const dispatch = useDispatch()
    const getData = useSelector(store => store.StudyInCanada)
    let {slug} = useParams();

    // api call
    useEffect(() => {
        let api_url = apiEndPoints.STUDY_IN_CANADA_DETAILS
        dispatch(fetchStudyInCanadaDetails([api_url + `/${slug}`]))
    })
...
export default StudyInCanadaDetails;
