...
import {fetchUniversityRankingDetails} from "../../api/redux/UniversityRanking";

const UniversityRankingDetails = () => {

    const dispatch = useDispatch()
    const getData = useSelector(store => store.universityRanking)
    let {slug} = useParams();

    // api call
    useEffect(() => {
        let api_url = apiEndPoints.UNIVERSITY_RANKING_DETAILS
        dispatch(fetchUniversityRankingDetails([api_url + `/${slug}`]))
    }, [])
...
export default UniversityRankingDetails;
