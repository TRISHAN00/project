...
import {fetchWhatToPack} from "../../api/redux/WhatToPack";
...
const WhatToPack = () => {
    ...
    // api call
    useEffect(() => {
        let api_url = apiEndPoints.WHAT_TO_PACK
        dispath(fetchWhatToPack([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state.whatToPack)
    ...
    return (
        <HelmetProvider>
            <Helmet>
                ...
                <meta name="What to pack"
                      content="Essential Steps for International Students Before Going Abroad"/>
            </Helmet>
