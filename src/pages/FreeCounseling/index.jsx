...
import {fetchFreeCounseling} from "../../api/redux/FreeCounseling";
...
const FreeCounseling = () => {
    ...
    // api call
    useEffect(() => {
        let api_url = apiEndPoints.FREE_CONSELTING
        dispath(fetchFreeCounseling([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state.freeCounseling)
    ...
    return (
        <HelmetProvider>
            <Helmet>
                ...
                <meta name="Counseling for free study abroad"
                      content="We assist students studying in Australia, the United Kingdom, the United States, and Canada. Our vast network of approachable professionals assists you in identifying and securing the perfect institution or school."/>
            </Helmet>
            <StyledInternationStudy>
                <InnerBanner first={'Home'} firstUrl={'/'} second={'What do we do'} title={innerBanner?.subtitle}
