...
import {fetchStudyInUkDetails} from "../../api/redux/StudyInUk";

const StudyInUkDetails = () => {

    const dispatch = useDispatch()
    const getData = useSelector(store => store.studyInUk)
    let {slug} = useParams();

    // api call
    useEffect(() => {
        let api_url = apiEndPoints.STUDY_IN_UK_DETAILS
        dispatch(fetchStudyInUkDetails([api_url + `/${slug}`]))
    })
...
export default StudyInUkDetails;
