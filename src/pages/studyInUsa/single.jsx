...
import {fetchStudyInUsaDetails} from "../../api/redux/StudyInUsa";

const StudyInUsaDetails = () => {

    const dispatch = useDispatch()
    const getData = useSelector(store => store.studyInUsa)
    let {slug} = useParams();

    // api call
    useEffect(() => {
        let api_url = apiEndPoints.STUDY_IN_USA_DETAILS
        dispatch(fetchStudyInUsaDetails([api_url + `/${slug}`]))
    })
...
export default StudyInUsaDetails;
