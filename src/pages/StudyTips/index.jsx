...
import {fetchStudyTips} from "../../api/redux/StudyTips";
...
const StudyTips = () => {
    ...
    // api call
    useEffect(() => {
        let api_url = apiEndPoints.STUDY_TIPS
        dispath(fetchStudyTips([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state.studyTips)
    ...
    return (
        <HelmetProvider>
            ...
            <StyledInternationStudy>
                <InnerBanner first={'Living Abroad'} second={innerBanner?.subtitle} title={innerBanner?.subtitle}
