...
import {fetchCourseAdvice} from "../../api/redux/CourseAdvice";
...
const CourseAdvice = () => {
    ...
    // api call
    useEffect(() => {
        let api_url = apiEndPoints.COURSE_ADVICE
        dispath(fetchCourseAdvice([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state.courseAdvice)
    ...
    return (
        <HelmetProvider>
            <Helmet>
                ...
                <meta name="Course Recommendation"
                      content="Let us assist you in locating a course that meets your career objectives."/>
            </Helmet>
