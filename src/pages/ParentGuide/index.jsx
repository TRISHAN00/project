...
import {fetchParentGuide} from "../../api/redux/ParentGuide";
...
const ParentGuid = () => {
    ...
    // api call
    useEffect(() => {
        let api_url = apiEndPoints.PARENT_GUID
        dispath(fetchParentGuide([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state.parentGuid)
    ...
    return (
        <HelmetProvider>
            <Helmet>
                ...
                <meta name="Parents guide"
                      content="Going abroad for studying is an exciting and life-changing experience for any student. If you are a Bangladeshi student who is planning to study abroad, here is a parents' guide to help you navigate through the process:
                      "/>
            </Helmet>
