...
import {fetchReasonToDoyen} from "../../api/redux/ReasonToChooseDoyen";
import AddressCard from "../../components/AddressCard";
import PopularCourse from "../../components/PopularCourse";
import CustomAccordion from "../../components/CustomAccordion";
import CustomTable from "../../components/RankingDesire/CustomTable";

const ReasonToChooseDoyen = () => {

    const dispath = useDispatch();

    // api call
    useEffect(() => {
        let api_url = apiEndPoints.REASON_TO_CHOOSE_DOYEN
        dispath(fetchReasonToDoyen([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state.reasonToChooseDoyen)
    ...
    return (
        <HelmetProvider>
            <Helmet>
                ...
                <meta name="Reasons to Choose Doyen & Associates"
                      content="Studying abroad is an exciting opportunity that offers immense personal"/>
            </Helmet>
...
export default ReasonToChooseDoyen;
