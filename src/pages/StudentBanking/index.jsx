...
import {fetchStudentBanking} from "../../api/redux/StudentBanking";
...
const StudentBanking = () => {
    ...
    // api call
    useEffect(() => {
        let api_url = apiEndPoints.STUDENT_BANKING
        dispath(fetchStudentBanking([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state.studentBanking)
