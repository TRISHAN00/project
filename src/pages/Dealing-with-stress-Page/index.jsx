...
import {fetchDealingWithStress} from "../../api/redux/DealingWithStress";

const DealingWithStress = () => {

    const dispath = useDispatch();

    // api call
    useEffect(() => {
        let api_url = apiEndPoints.DEALING_WITH_STREES
        dispath(fetchDealingWithStress([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state.dealingWithStress)
    ...
    return (
        <HelmetProvider>
            <Helmet>
                ...
                <meta name="Dealing with stress" content="As a Bangladeshi student, pursuing higher "/>
            </Helmet>
            <StyledInternationStudy>
                <InnerBanner first={'Home'} firstUrl={'/'} second={'Living Abroad'} img={innerBanner?.image}
...
export default DealingWithStress;
