...
const ScholarshipDetails = () => {
    ...
    const getData = useSelector(store => store.scholarships)
    let {slug} = useParams();

    // api call
    useEffect(() => {
        let api_url = apiEndPoints.SCHOLARSHIPS_DETAILS
        dispatch(fetchScholarshipsDetails([api_url + `/${slug}`]))
    }, [])
...
"/>
            ...
            <StyledInternationStudy>
                ...
                {
                    cta && <Feature subtitle={cta?.subtitle} leftText={cta?.left_text} rightTopSmall={cta?.right_top}
