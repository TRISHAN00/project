...
import {fetchManagingMoney} from "../../api/redux/ManaginMoney";
...
const ManagingMoney = () => {
    ...
    // api call
    useEffect(() => {
        let api_url = apiEndPoints.MANAGING_MONEY
        dispath(fetchManagingMoney([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state.managingMoney)
    ...
    return (
        <HelmetProvider>
            <Helmet>
                ...
                <meta name="Managing Finances"
                      content="Studying abroad can be an exciting and life-changing experience for Bangladeshi students."/>
            </Helmet>
