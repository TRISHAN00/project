...
import {fetchScholarshipsDetails} from "../../api/redux/Scholarships";
...
import {fetchIeltsScoreDetails} from "../../api/redux/IeltsScore";

const IeltsScoreDetails = () => {

    const dispatch = useDispatch()
    const getData = useSelector(store => store.ieltsScore)
    let {slug} = useParams();

    // api call
    useEffect(() => {
        let api_url = apiEndPoints.IELTS_SCORE_DETAILS
        dispatch(fetchIeltsScoreDetails([api_url + `/${slug}`]))
    }, [])
...
export default IeltsScoreDetails;
