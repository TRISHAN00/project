...
import {fetchJobSeeking} from "../../api/redux/JobSeekingTips";

const JobSeekingTips = () => {

    const dispath = useDispatch();

    // api call
    useEffect(() => {
        let api_url = apiEndPoints.JOB_SEEKING_TIPS
        dispath(fetchJobSeeking([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state.jobSeekingTips)
    ...
    return (
        <HelmetProvider>
            <Helmet>
                ...
                <meta name="Job Seeking Tips"
                      content="Studying abroad provides an excellent opportunity for Bangladeshi students to gain a global perspective and enhance their academic and personal development"/>
            </Helmet>
