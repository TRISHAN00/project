...
import {fetchSuccessStory} from "../../api/redux/SuccessStory";
...
const SuccessStory = () => {
    ...
    // api call
    useEffect(() => {
        let api_url = apiEndPoints.SUCCESS_STORY
        dispath(fetchSuccessStory([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state?.successStory)
    ...
    return (
        <HelmetProvider>
            <Helmet>
                ...
                <meta name="Success Story"
                      content="Studying abroad provides an excellent opportunity for Bangladeshi students to"/>
            </Helmet>
