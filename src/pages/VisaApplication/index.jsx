...
import {fetchVisaAssistant} from "../../api/redux/VisaAssistance";
...
const VisaApplication = () => {
    ...
    // api call
    useEffect(() => {
        let api_url = apiEndPoints.VISA_ASSISTANT
        dispath(fetchVisaAssistant([api_url]))
    }, [dispath])

    let getPost = useSelector(state => state.visaAssistancer)
    ...
    return (
        <HelmetProvider>
            <Helmet>
                ...
                <meta name="Visa Application Assist"
                      content="Doyen provides student visa application support."/>
            </Helmet>
